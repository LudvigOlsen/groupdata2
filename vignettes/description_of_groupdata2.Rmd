...
n represents either number of groups, group size, step size or the number to start at, depending on which method is specified.  
...
k represents either number of folds, fold size, step size or number to start at, depending on which method is specified.  
