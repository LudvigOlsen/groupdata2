...
test_that("testing combine_and_fold_combination_()", {
  ...
  expect_equal(
    ...
    structure(c(2L, 4L, 1L, 6L, 3L, 5L, 7L, 8L), .Label = c("1", "2",
      "3", "4", "5", "6", "7", "8"), class = "factor"))
  expect_equal(
    summaries[["answer"]],
    c(0.3021, 0.63334, -0.73018, 0.39942, -0.47707, -0.16561, -0.20465,
      0.24265),
    tolerance = 1e-4)
  expect_equal(
    summaries[["score"]],
    c(486, 484, 154, 400, 227, 227, 323, 399),
    tolerance = 1e-4)
  expect_equal(
    summaries[["age"]],
    c(348, 477, 136, 107, 268, 348, 186, 568),
    tolerance = 1e-4)
  expect_equal(
    summaries[["size"]],
    c(8, 9, 4, 8, 5, 6, 6, 7),
  ...
  expect_equal(
    names(summaries),
    c(".old_groups", "answer", "score", "age", "size", "participant", "participant_2"),
    fixed = TRUE)
  # Testing column classes
  expect_equal(
