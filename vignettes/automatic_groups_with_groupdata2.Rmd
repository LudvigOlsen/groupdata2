...
We would like to get the ratings into the dataframes with observations. For this we will first create a session column, and then get the ratings for the sessions.
...
Now that we have the session information, we can transfer the ratings from the ratings dataframe.
...
Let's transfer the averages to the merged dataframe. Once again, we just use merge().
...
It seems like they follow each other pretty neatly. 
