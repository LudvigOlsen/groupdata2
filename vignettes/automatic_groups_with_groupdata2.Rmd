...
In this vignette, we will use the 'l_starts' method with **group**() to allow transfering of information from one dataset to another. We will use the automatic grouping function that finds group starts all by itself.
