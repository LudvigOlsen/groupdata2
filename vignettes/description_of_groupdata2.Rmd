...
date: "`r Sys.Date()`"
abstract: |
  groupdata2 is a set of subsetting methods for easy grouping, windowing, folding, partitioning, splitting and balancing of data.  
...
Greedy means that each group grabs as many elements as possible (up to the specified size),
...
7. Using balance() for dowsampling to a specific size with id_col and id_method 'n_rows_c'  
