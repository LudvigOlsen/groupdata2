...
test_that("testing summarize_balances()", {
  ...
  expect_equal(
    ...
    c(4, 4, 4, 4, 4, 4, 1, 1, 1, 1, 1, 1, 2.5, 2.5, 2.5, 2.5, 2.5, 2.5,
...
test_that("testing measure_summary_numerics_() and join_group_summaries_()", {
  ...
  man_measured_summ <- man_measured_summ %>%
    dplyr::left_join(
      man_measured_summ %>%
        ...
        mean_rank_numeric_cols_(cols = c("# some_f_1", "# some_f_2", "# some_f_3"), col_name = "some_f_SD_rank") %>% print() %>%
  ...
  expect_equal(
    ...
    structure(c(1L, 1L, 1L, 1L, 1L, 1L, 2L, 2L, 2L, 2L, 2L, 2L), .Label = c("grp_1",
                                                                            "grp_2"), class = "factor"))
  expect_equal(
